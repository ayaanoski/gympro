  ...
  return (
    <div className="min-h-screen bg-[#fbfbfe] flex flex-col md:flex-row font-sans">
      {isTrainer ? (
        <>
          {/* Top Bar for Trainer */}
          <div className="bg-white/80 backdrop-blur-md border-b px-4 md:px-10 py-3 flex items-center justify-between sticky top-0 z-50">
            <h1 className="text-xl font-extrabold tracking-tight text-gray-900">
              GYM<span className="text-brand-primary">PRO</span>
            </h1>
            <div className="flex items-center gap-3">
              <span className="text-sm font-bold text-gray-400 hidden sm:block">{userProfile?.name}</span>
              <button onClick={handleLogout} className="flex items-center gap-2 px-4 py-2 text-red-500 hover:bg-red-50 rounded-xl transition-all font-bold text-sm">
